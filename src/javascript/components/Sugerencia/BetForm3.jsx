      ...
      <Row gutter={[20, 0]}>
        ...
        <Col xs={24} sm={24} lg={24}>
          <JoiInputNumber
            ...
            name={['request', parentIndex, 'probabilidad', 2]}
          />
        </Col>
      </Row>
    </Col>
      ...
      <Row gutter={[20, 0]}>
        ...
        <Col xs={24} sm={24} lg={24}>
          <JoiInputNumber
            ...
            name={['request', parentIndex, 'apuestas', 2]}
          />
        </Col>
      </Row>
    </Col>
